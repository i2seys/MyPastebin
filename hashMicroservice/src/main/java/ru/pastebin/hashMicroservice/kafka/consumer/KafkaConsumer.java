...
public class KafkaConsumer {
    ...
    @Autowired
    public KafkaConsumer(KafkaTopic kafkaTopic, HashGenerator hashGenerator) {
    ...
    private void createPasteListener(ConsumerRecord<String, Void> record) {
        ...
        //TODO: сделать отправку в PasteMicroservice c помощью producer.
    }
}
